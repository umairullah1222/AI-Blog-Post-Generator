...
import { HomeIcon, PostsIcon, SettingsIcon, PenIcon, HistoryIcon, AutomationIcon, ResearchIcon, UserIcon } from './icons.tsx';
...
function Sidebar(): React.ReactNode {
    ...
    const onNavigate = (view: View) => {
        const protectedViews: View[] = ['posts', 'research', 'history', 'automation', 'profile'];

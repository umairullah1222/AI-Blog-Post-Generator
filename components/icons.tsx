...
export const WordPressIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm5.438 6.563l-2.188 6.063-1.312-3.813-1.313 3.813-2.187-6.063h1.5l1.438 4.188 1.312-4.188h1.313zm-9.312 0l2.312 6.375L8.25 15.5l-1.187-3.438-1.188 3.438L3.563 8.563h1.5l.812 2.563.813-2.563h1.437z" />
    </svg>
);
